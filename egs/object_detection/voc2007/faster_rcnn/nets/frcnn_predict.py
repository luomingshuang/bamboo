...
from local.cvtransforms import (cvtColor, get_new_img_size, resize_image,
                         preprocess_input)
from local.utils import get_classes, show_config
...
class FRCNN(object):
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='download/voc2007_model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
