...
def get_parser():
    ...
    parser.add_argument(
        "--test-results-dir",
        type=str,
        default="deformable-detr/exp/test_samples_results",
    ...
    parser.add_argument(
        ...
        type=str,
        default="deformable-detr/download/r50_deformable_detr-checkpoint.pth",
    ...
    # Variants of Deformable deformable-detr
    parser.add_argument(
        "--with-box-refine",
        default=False,
        action="store_true",
