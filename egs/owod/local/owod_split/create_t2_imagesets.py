...
dest_file = '/home/bcxiong1/codes/bamboo-mscoco2017-owod/egs/owod/data/OWOD/VOC2007/ImageSets/Main/t2_train.txt'
...
dest_file = '/home/bcxiong1/codes/bamboo-mscoco2017-owod/egs/owod/data/OWOD/VOC2007/ImageSets/Main/t2_test.txt'
...
dest_file = '/home/bcxiong1/codes/bamboo-mscoco2017-owod/egs/owod/data/OWOD/VOC2007/ImageSets/Main/t2_test_unk.txt'
with open(dest_file, 'w') as file:
    for image_id in image_ids:
        file.write(str(image_id)+'\n')
