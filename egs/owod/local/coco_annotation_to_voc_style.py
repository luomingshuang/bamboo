...
if __name__ == '__main__':
    coco_annotation_train_file = '/home/bcxiong1/data/coco2017/annotations/instances_train2017.json'
    train_target_folder = '/home/bcxiong1/data/voc_2007_2012_coco_2017/VOC2007'

    coco_to_voc_detection(coco_annotation_train_file, train_target_folder)

    coco_annotation_val_file = '/home/bcxiong1/data/coco2017/annotations/instances_val2017.json'
    val_target_folder = '/home/bcxiong1/data/voc_2007_2012_coco_2017/VOC2007'

    coco_to_voc_detection(coco_annotation_val_file, val_target_folder)
